...
{
    class SkeletonScene : Scene
    {
        private int power = r.Next(1, 15);
        ...
        public SkeletonScene(Game game) : base(game)
        {
        ...
        {
            string prompt = @"A regular looking skeleton! You should be able to see this by yourself, but I'll spoil it for you:*
...
"You have " + MainDungeon.myHero.potions + " potions left. *";
        ...
        private void Attack()
        {
            ...
            int attack = r.Next(10, MainDungeon.myHero.weaponValue) + r.Next(10, 20);
            WriteLine("The skeleton loses " + attack + "health. You lose " + damage + "health.");
            ...
            else
            {
                ...
                else
                {
                    ...
                    WriteLine("Skeleton's dead. It dropped " + drop + " coins");
                    WriteLine("Now you have " + MainDungeon.myHero.coins + " coins");
                    ResetColor();
                    NavigationScene.skeletonFlag = true;
                    ConsoleUtils.WaitForKeyPress();
        ...
        private void Defend()
        {
            ...
            if(index < 5)
            {
                WriteLine("You try to run away, but block the skeletons attack by accident.");
            ...
            else
            {
                ...
                WriteLine("Skeleton can see right through your plans. You fail to block and lose " + damage + " health.");
                MainDungeon.myHero.health -= damage;
